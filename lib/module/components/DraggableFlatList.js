...
function DraggableFlatListInner(props) {
  ...
  const gestureDisabled = useSharedValue(false); // WORKAROUND: There is a slight delay after the animation is completed in Android, so let it send 100ms and change the flag.
